...
namespace Emma.Core.Options
{
    ...
    /// </summary>
    public static class InteractionContextOptions
    {
        /// <summary>
        /// The configuration section name for interaction context options.
        /// </summary>
        public const string SectionName = "InteractionContext";
    }
