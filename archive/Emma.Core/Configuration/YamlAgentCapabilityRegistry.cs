...
namespace Emma.Core.Configuration
{
    ...
    public class YamlAgentCapabilityRegistry : IAgentCapabilityRegistry, IDisposable
    {
        ...
        // --- BEGIN: Missing IAgentCapabilityRegistry methods ---
        public Task<AgentCapability?> GetCapabilityAsync(string agentType)
        {
            throw new NotImplementedException();
        }

        public Task<bool> IsActionAllowedAsync(string agentType, string action)
        {
            throw new NotImplementedException();
        }
        // --- END: Missing IAgentCapabilityRegistry methods ---
