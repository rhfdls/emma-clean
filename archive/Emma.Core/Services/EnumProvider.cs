...
public class EnumProvider : IEnumProvider
{
    ...
    public async Task<EnumMetadata?> GetEnumMetadataAsync(string enumType)
    {
        throw new NotImplementedException();
    }

    public async Task<IEnumerable<string>> GetAvailableEnumTypesAsync()
    {
        throw new NotImplementedException();
    }

    public IEnumerable<string> GetAvailableEnumTypes()
    {
        throw new NotImplementedException();
    }
