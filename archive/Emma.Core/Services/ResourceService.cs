...
public class ResourceService : IResourceService
{
    ...
    public async Task<ContactAssignment> AssignResourceAsync(
        ...
        Guid organizationId,
        string purpose,
        ContactAssignmentStatus status = ContactAssignmentStatus.Active,
    ...
    public async Task<List<ContactAssignment>> GetResourceAssignmentsAsync(
        ...
        ContactAssignmentStatus? status = null)
    {
        ...
        bool includeCompleted = false)
    {
        ...
        if (!includeCompleted)
        {
            query = query.Where(ca => ca.Status != ContactAssignmentStatus.Completed && ca.Status != ContactAssignmentStatus.Cancelled);
        }
    ...
    public async Task<object> GetResourceMetricsAsync(Guid resourceId)
    {
        ...
        var completedAssignments = assignments.Where(a => a.Status == ContactAssignmentStatus.Completed).ToList();
