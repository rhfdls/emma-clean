...
using Emma.Core.Models; // Keep for other models
...
public class NbaAgent
{
    ...
    private async Task<AgentResponse> GenerateRuleBasedFallbackAsync(Guid contactId, Guid organizationId, 
        Emma.Models.Models.NbaContext nbaContext, ContactState contactState, string traceId, DateTime startTime)
    {
    ...
    /// </summary>
    private async Task<List<NbaRecommendation>> ParseLLMResponseAsync(string llmResponse, Emma.Models.Models.NbaContext nbaContext, string traceId)
    {
        try
        {
