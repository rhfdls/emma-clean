...
public class ContextIntelligenceAgent : AgentBase, IContextIntelligenceAgent
{
    ...
    private Task<object> AnalyzeSentimentAsync(NbaContext context, string? traceId)
    {
    ...
    private Task<object> AnalyzeEngagementAsync(NbaContext context, string? traceId)
    {
    ...
    private Task<object> AnalyzeIntentAsync(NbaContext context, string? traceId)
    {
